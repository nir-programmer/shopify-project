...
*** Thanks again!
-->
# Shopify: Spring Boot Web Application - Using Multiple Maven Modules [![Build Status](https://travis-ci.org/AnanthaRajuC/Spring-Boot-Application-Template.svg?branch=master)](https://travis-ci.org/github/AnanthaRajuC/Spring-Boot-Application-Template)

This Project is **Complete** Project which is   a **recipe/scaffolding** for bootstrapping a **Monolithic Web Application** with the features & Technology stack listed below. Delete the sample code (or keep it.) and add your own, you’re good to go.

<!-- APPLICATION SCREENSHOTS -->
## Application screenshots
### Admin Home Page
[![Home](DOCUMENTS/Shopify-BackEnd-Project/images/admin-home-page.png)](DOCUMENTS/Shopify-BackEnd-Project/images/admin-home-page.png)

**More [Screenshots](documents/SCREENSHOTS.md)**



The Shopify Back End Project:
Features include:

- [User Management Module](DOCUMENTS/User-Management-Module/User_Management_Module.MD)  
   
      
- [User Authentiaction](documents/USER_PROFILES.MD)   
- [User Authorization](documents/USER_ROLES.MD)   
- [Category Managememnt Module](documents/USER_ROLES.MD) 
- [Brand Managememnt Module](documents/USER_ROLES.MD) 
- [Product Managememnt Module](documents/USER_ROLES.MD) 
- [Category Managememnt Module](documents/USER_ROLES.MD) 
- [Listing Prodcuts for Customers](documents/USER_ROLES.MD) 
- [Setting Managememnt](documents/USER_ROLES.MD) 
- [Customer Registration](documents/USER_ROLES.MD) 
- [Customer Managememnt Module](documents/USER_ROLES.MD) 
- [Category Managememnt Module](documents/USER_ROLES.MD) 
- [Customer Authentication Module](documents/USER_ROLES.MD) 
- [Shoppint Cart Module](documents/USER_ROLES.MD) 
- [Shipping Rates Managememnt Module](documents/USER_ROLES.MD) 
- [Address Book Module](documents/USER_ROLES.MD) 
- [Order Managememnt Module - Part 1](documents/USER_ROLES.MD) 
- [Checkout Managememnt Module](documents/USER_ROLES.MD) 
- [Order Managememnt Module - Part 1](documents/USER_ROLES.MD) 
- [Order Managememnt for Shipping  Module](documents/USER_ROLES.MD) 
- [Order Managememnt for Customer  Module](documents/USER_ROLES.MD) 
